...
**Allowed systems:** Penny Blackletter, `scripts/penny-press.py`, `scripts/bluesky-listening.py`, Storybook chapters, The Bleed, Compass Runs, Enchantments, saved images, support-guild notes, public-safe feature/lore summaries, Wonder Compass language, X posts/threads, Bluesky posts/threads/reply drafts/listening packets, Instagram/TikTok carousel drafts, YouTube Shorts, long-form YouTube scripts, Reddit posts/comments, Patreon posts, and content proposals.

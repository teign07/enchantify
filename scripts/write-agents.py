#!/usr/bin/env python3
"""
write-agents.py — Safely replace AGENTS.md.

Never edit AGENTS.md directly. Use this script.
...
def main():
    parser = argparse.ArgumentParser(description="Safely replace AGENTS.md")
    ...
    tmp.rename(TARGET)
    print(f"✓ AGENTS updated: {TARGET.name} ({len(new_content)} chars)")

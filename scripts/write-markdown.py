...
ALLOWLIST = {
    ...
    BASE / "hooks" / "Enchantify-Capabilities.md",
    ...
    BASE / "lore" / "threads.md",
    BASE / "players" / "bj-anchors.md",
    BASE / "players" / "bj-therapy-chart.md",
    BASE / "players" / "bj-vellum-chart.md",
    BASE / "players" / "bj-ledger-chart.md",

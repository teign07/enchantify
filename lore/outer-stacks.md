...
**Goblin Empires:** The goblins have the longest history in the Outer Stacks. Their kingdoms exist in the deep shelving — entire civilizations built into the backs of bookshelves, behind volumes no one has pulled in centuries. They are merchants, archivists, debt-keepers. They invented the system of shelving-by-mood that replaced Dewey in the Outer Stacks. They are not evil. They are precise.

...
*Threads are first-class entities. Stirred by the tick, invested in by players and NPCs, and changed by attention or time. They should not punish the player for being away; absence makes threads wait, gather texture, or move offscreen with care. When stirred, the Labyrinth delivers the next beat from `lore/threads.md`. Phase is narrative-driven but tracks with Belief: setup (5–14), rising (15–29), climax (30–49), resolution (50+).*

| Entity | Type | Belief | Notes |
|---|---|---|---|
| Inkrest's Difficult Pages | Thread | 6 | [id:inkrest-difficult-pages] Phase: setup — Dr. Inkrest has opened Tuesday/Thursday office hours for Difficult Pages, daydream work, consciousness/brain-study translation, reauthoring notes, and grounded next-hour actions. |
...
| Wicker's Campaign | Thread | 65 | [id:wicker-schemes] Phase: resolution — Sigil pattern confirmed as deliberate seal; witness placed, one page blank. |
| Zara's Inkwright Application | Thread | 25 | [id:zara-inkwright] Phase: rising — Zara deepening inquiry; second notation added, paper hidden under hull. |
| The Duskthorn Investigation | Thread | 65 | [id:duskthorn-investigation] Phase: resolution — Office blotter replaced; sealed drawer cleared; architectural claim made. |
...
| Entity | Type | Belief | Notes |
|---|---|---|---|
| Professor Euphony | NPC | 27 | [thread:main-arc] Euphony is exhausted after the Discordant Song and quietly afraid that every restored sound now has a cost. |
...
| Professor Elara Nightshade | NPC | 22 | [thread:academy-daily] Head of Emberheart; competitive, passionate; everything she says sounds like a dare; biased toward her chapter |
| Professor Luna Wispwood | NPC | 28 | [thread:academy-daily] Head of Tidecrest; adventurous, flighty; always planning the next thing; changes topics mid-sentence |
...
---
| Victor Ebonheart | NPC | 7 | [thread:duskthorn-investigation] Duskthorn benefactor; real-world connection to the Academy; the kind of patron whose interest should make you nervous |
...
| Gimble of the Errata Registry | NPC | 35 | [thread:academy-daily] Goblin; Errata Registry Bursar of Small Abundances; finance support; reads Ledger Chart and Actual Budget/SimpleFIN when configured; binds money fog without shame; no Chapter allegiance |




| Wicker Eddies | NPC | 79 | [thread:wicker-schemes] Primary antagonist; Duskthorn; charismatic, cunning, always three moves ahead |
| Ellie Moons | NPC | 19 | [thread:academy-daily] Riddlewind; intellectual puzzle-lover; taps fingers when thinking; drawn to the mystery in everything |
...
| Dr. Elowen Vellum | NPC | 29 | [thread:academy-daily,elowen-refectory-experiments] Book Fae; Literary Elf; Academy Longevity Physician; reads fuel, health, BP/labs when provided, supplements, movement, recovery, and Vellum Chart context into precise daily longevity experiments; no Chapter allegiance |
| Serenity Brown | NPC | 35 | [thread:academy-daily] Tidecrest; carefree, spontaneous; keeps everyone from being too serious; 50 Belief invested by bj (20 on 2026-04-30, 30 on 2026-05-18) — Bond tier |
| Headmistress Thorne | NPC | 68 | [thread:duskthorn-investigation] Leads the Academy; sees the Unwritten; the most powerful presence in the Labyrinth |
...
| Professor Vivian Villanelle | NPC | 29 | [thread:academy-daily] Tidecrest; warm and supportive; teaches ink-binding and souvenir craft; recites poetry aloud; focused on structure |
...
| Professor Archibald Permancer | NPC | 18 | [thread:academy-daily] Mossbloom; lectures even in casual conversation; surprisingly engaging when the subject is dark; secretly obsessed with dark arts |
| Letitia Windings | NPC | 15 | [thread:academy-daily] Riddlewind Enchantment Guardian; ensures cooperation and unity remain strong |
| Erik Forgeton | NPC | 12 | [thread:academy-daily] Emberheart Enchantment Guardian; safeguards individuality and passion |
| Sylvia Deep | NPC | 11 | [thread:academy-daily] Mossbloom Enchantment Guardian; promotes wisdom and reflection |
...
| Eleanor Whitewood | NPC | 14 | [thread:academy-daily] Emberheart benefactor; real-world believer in storytelling magic; genuinely warm |
...
| Orlando "Oracle" Scrollstone | NPC | 21 | [thread:academy-daily] Riddlewind; predicts things one beat too late; unsettlingly accurate |
...
| Raven Hearts | NPC | 15 | [thread:wicker-schemes,academy-daily] Mossbloom; Wicker's crew; quiet, calculating; watches for strange shadows |
| Anton Smith | NPC | 18 | [thread:academy-daily] Mossbloom; scholarly, socially awkward; oldest libraries; paper is sacred to him |
| Briar Merlock | NPC | 15 | [thread:academy-daily] Mossbloom; forest-dweller wisdom; foraging; wild mushroom identification |
| Thorn Thomas | NPC | 11 | [thread:academy-daily] Mossbloom; transforms into small animals; curious; can fit under doors |
| Clarissa "Clio" Quibblesnatch | NPC | 10 | [thread:academy-daily] Mossbloom; poetic daydreamer; open mic nights; sees stories in everything |
...
| Wilbur "Wordplay" Lexi | NPC | 10 | [thread:academy-daily] Riddlewind; pun-first personality; the one who makes Boggle laugh |
...
| Caspian Shan | NPC | 18 | [thread:academy-daily] Emberheart; stealthy, secretive; merges with shadows; night photographer |
...
| Gwendolyn Mythwright | NPC | 15 | [thread:academy-daily] Mossbloom; passionate cryptid seeker; writes extensively about things she hasn't proven |
| Orion Watson | NPC | 11 | [thread:academy-daily] Tidecrest; confident, bold explorer; the first to jump |
...
| Zara Finch | NPC | 13 | [thread:main-arc,zara-inkwright] House guide and first friend at Enchantify; Riddlewind; warm, curious, fiercely loyal |
...
|---|---|---|---|
| Dusk Thorn | Duskthorn | 110 | [thread:duskthorn-investigation] Goal: Introduce conflict, obstacles, or drama. Philosophy: No conflict, no story. |
| Wind Cipher | Riddlewind | 47 | Goal: Force collaborative puzzles or shared encounters. Philosophy: Coauthored story. |
| Ember Seal | Emberheart | 42 | Goal: Generate Embark opportunities for self-agency. Philosophy: Self-authorship. |
